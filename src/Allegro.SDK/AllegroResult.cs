...
namespace Allegro.SDK
{
    ...
    /// 响应实体
    /// </summary>
    public class AllegroResult
    {
        /// <summary>
        /// 响应码
        /// </summary>
        public AllegroResultCode Code { get; set; }
        /// <summary>
        /// 响应信息
        /// </summary>
        ...
        /// 成功
        /// </summary>
        public bool IsSuccess => Code == AllegroResultCode.Succeed;
        /// <summary>
        /// 时间戳(毫秒)
        /// </summary>
        ...
        {
            Message = message;
            Code = AllegroResultCode.Succeed;
        }
        /// <summary>
        /// 响应失败
        /// </summary>
    ...
    public class AllegroResult<T> : AllegroResult
    {
        /// <summary>
        /// 返回结果
        /// </summary>
